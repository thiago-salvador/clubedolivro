...
export const SettingsIcon: React.FC<IconProps> = ({ size = 20, className = '' }) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m4.22-10.22l4.24 4.24M6.34 6.34L2.1 2.1m17.8 17.8l-4.24-4.24M6.34 17.66l-4.24 4.24M1 12h6m6 0h6m-10.22 4.22l-4.24 4.24M17.66 6.34l4.24-4.24"></path>
  </svg>
);
...
// ShoppingBag Icon
export const ShoppingBagIcon: React.FC<IconProps> = ({ size = 20, className = '' }) => (
  <svg 
    className={className}
    width={size} 
    height={size} 
...
// MessageCircle Icon
export const MessageCircleIcon: React.FC<IconProps> = ({ size = 20, className = '' }) => (
  <svg 
    className={className}
    width={size} 
    height={size} 
