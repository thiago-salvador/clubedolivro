        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative order-first lg:order-last">
            <div className="relative">
              <div 
                className="relative overflow-hidden rounded-xl transform hover:scale-105 hover:-translate-y-2 transition-all duration-300 max-w-md mx-auto lg:max-w-none" 
                style={{
